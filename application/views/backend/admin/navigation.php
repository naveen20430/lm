...
<div class="left-side-menu left-side-menu-detached">
	...
	<!--- Sidemenu -->
		<ul class="metismenu side-nav side-nav-light">
			...
			<li class="side-nav-item <?php if ($page_name == 'school' || $page_name == 'school_add' || $page_name == 'school_edit' ): ?> active <?php endif; ?>">
				<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'school' || $page_name == 'school_add' || $page_name == 'school_edit' ): ?> active <?php endif; ?>">
					<i class="dripicons-network-1"></i>
					<span> <?php echo get_phrase('school'); ?> </span>
					<span class="menu-arrow"></span>
				</a>
				<ul class="side-nav-second-level" aria-expanded="false">
					<li class = "<?php if($page_name == 'school' || $page_name == 'category_edit') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/school'); ?>"><?php echo get_phrase('school'); ?></a>
					</li>

					<li class = "<?php if($page_name == 'category_add') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/school_form/add_school'); ?>"><?php echo get_phrase('add_new_school'); ?></a>
					</li>
				</ul>
			</li>
